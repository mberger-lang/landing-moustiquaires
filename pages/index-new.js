...
const ogImage = `${canonicalUrl}images/logo-caseo.svg`;
const showroomUrl =
...
const solutions = [
  {
    ...
    text: "La solution la plus demandée pour les fenêtres. Facile à ouvrir, discrète et durable au quotidien.",
    art: "fenetre",
  },
  {
    title: "Moustiquaire plissée",
    text: "Parfaite pour les portes-fenêtres et baies vitrées. Ouverture latérale souple et très bon confort d'usage.",
    art: "baie",
  },
  {
    title: "Moustiquaire fixe",
    text: "Simple, discrète et durable pour les ouvertures peu sollicitées. Une protection propre et permanente.",
    art: "fixe",
  },
];
...
const reviews = [
  {
    ...
    rating: "5/5",
    text: "Excellente expérience du début à la fin. Très bons conseils et installation impeccable.",
  },
  {
    name: "Manon Malavasi",
    rating: "5/5",
    text: "Super projet. Nous sommes ravis de notre nouvelle porte d'entrée. Équipe top et accompagnement rassurant.",
  },
  {
...
const faqs = [
  {
    question: "Quel type de moustiquaire choisir ?",
    answer:
      "Pour une fenêtre standard, la moustiquaire enroulable est souvent le meilleur choix. Pour une porte-fenêtre ou une baie vitrée, la plissée est généralement la plus confortable à l'usage.",
  },
  {
    question: "Proposez-vous la pose à Chambéry et autour ?",
    answer:
  ...
  {
    question: "Quels sont les horaires du showroom ?",
    answer:
        ...
        <section className="hero" id="top">
          <div className="container hero-grid">
            <div>
              ...
              <h1>
                Moustiquaire sur mesure à Chambéry avec <span>pose</span>
              </h1>
              <p className="lead">
                Fenêtres, portes-fenêtres, baies vitrées : protégez votre maison des
                moustiques tout l'été sans renoncer à l'air frais.
              </p>
              <ul className="ticks">
        ...
        <section className="gallery">
          <div className="container gallery-grid">
            <article className="gallery-card large">
              <div className="scene scene-showroom" aria-hidden="true" />
            ...
            <article className="gallery-card">
              <div className="scene scene-magasin" aria-hidden="true" />
              <div className="overlay">
                <span>Magasin</span>
              ...
              {solutions.map((solution, index) => (
                <article className="card" key={solution.title}>
                  <div className="card-media">
                    {solution.art === "fixe" ? (
                      <div className="placeholder">Protection discrète et durable</div>
                    ) : (
                      <div
                        className={
                          solution.art === "fenetre"
                            ? "scene scene-fenetre"
                            : "scene scene-baie"
                        }
                        aria-hidden="true"
          ...
          <div className="container">
            ...
            <div className="zone-list">
              {zones.map((zone, index) => (
                <span key={zone} className={index === 0 ? "zone active" : "zone"}>
                  {zone}
                </span>
              ))}
            </div>
            ...
            <div className="faq-list">
              {faqs.map((item, index) => (
                <div className="faq-item" key={item.question}>
                  ...
                  >
                    {item.question}
                    <span className={openFaq === index ? "faq-plus open" : "faq-plus"}>
                      +
                    </span>
                  </button>
        ...
        <section className="cta-wrap">
          <div className="cta-box">
            <div>
              ...
              <p>
                Devis gratuit, prise de mesures à domicile, fabrication sur mesure
                et pose par nos techniciens.
              </p>
            </div>
